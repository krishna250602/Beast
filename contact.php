			...
			<div class="contact-agileinfo">
				<div class="col-md-7 contact-form wthree">
					<form action="#" method="post">
						...
						<textarea placeholder="Enter the pass details" name="message" required=""></textarea>
...
{               ?>
						<p><i class="fa fa-map-marker"></i> KSRTC Bus Stand Davangere-577001 </p>
						<p><i class="fa fa-phone"></i> Mobile Number :9902537713</p>
						
						<p><i class="fa fa-envelope-o"></i> Email :ksrtcbus@gmail.com</p> <?php $cnt=$cnt+1;}} ?>
					</div> 
				</div> 
